import { PollInterface, PollCreateType, PollProgressType, PollSelectedItemType } from '../types/poll';
...
// TODO: 백엔드 API 이상으로 인해 itemIds 임시 타입 적용 (내가 안했는데 쏘리)
const progressPoll = (id: PollInterface['id'], itemIds: PollSelectedItemType[]) =>
