...
class DurationMinutesTest {
    ...
    public void 약속잡기_시간과_분을_합친다(int hours, int minutes, int total) {
        // given
    ...
    public void 약속잡기_진행_시간에서_시간과_분을_추출한다(int hours, int minutes) {
        // given
        DurationMinutes durationMinutes = new DurationMinutes(hours, minutes);
    ...
    public void 약속잡기_진행_시간이_자연적이지_않을_경우_예외를_던진다(int hours) {
        // when & then
    ...
    public void 약속잡기_진행_시간의_분이_자연적이지_않을_경우_예외를_던진다(int minutes) {
        // when & then
    ...
    public void 약속잡기_진행_시간이_30분_단위가_아닐_경우_예외를_던진다(int minutes) {
        // when & then
        assertThatThrownBy(() -> new DurationMinutes(0, minutes))
                .isInstanceOf(InvalidRequestException.class);
    }
    ...
    public void 약속잡기_진행_시간이_범위를_벗어날_경우_예외를_던진다(int hours, int minutes) {
        // when & then
